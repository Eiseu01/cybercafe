...
<body class="h-screen flex overflow-hidden font-sans text-gray-200">
    ...
    <main class="flex-1 flex flex-col overflow-hidden relative">
        ...
        <!-- Content Body -->
        <div class="flex-1 overflow-auto p-6" id="app">
            
            <!-- Stats Row -->
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <!-- Revenue -->
                <div class="glass-panel p-6 flex flex-col justify-between h-32 relative overflow-hidden group">
                    <div class="absolute -right-6 -top-6 w-24 h-24 bg-cyan-500/10 rounded-full blur-xl group-hover:bg-cyan-500/20 transition-all"></div>
                    <div class="flex justify-between items-start relative z-10">
                        <p class="text-cyan-500 text-[10px] uppercase font-bold tracking-widest font-mono">Total Revenue</p>
                        <i class="fas fa-coins text-cyan-400 opacity-80"></i>
                    </div>
                    <div class="relative z-10">
                        <h3 class="text-3xl font-bold text-white tracking-widest font-mono" id="stat-revenue">--</h3>
                ...
                <div class="glass-panel p-6 flex flex-col justify-between h-32 relative overflow-hidden group">
                    ...
                    <div class="flex justify-between items-start relative z-10">
                        <p class="text-emerald-500 text-[10px] uppercase font-bold tracking-widest font-mono">Active Nodes</p>
                        <i class="fas fa-network-wired text-emerald-400 opacity-80"></i>
                    </div>
                    <h3 class="text-3xl font-bold text-white tracking-widest font-mono" id="stat-occupied">--</h3>
                </div>
                ...
                <div class="glass-panel p-6 flex flex-col justify-between h-32 relative overflow-hidden group">
                    ...
                    <div class="flex justify-between items-start relative z-10">
                        ...
                        <i class="fas fa-desktop text-blue-400 opacity-80"></i>
                    </div>
                    <h3 class="text-3xl font-bold text-white tracking-widest font-mono" id="stat-available">--</h3>
                </div>
                 ...
                 <div class="glass-panel p-6 flex flex-col justify-between h-32 relative overflow-hidden group">
                    ...
                    <div class="flex justify-between items-start relative z-10">
                        <p class="text-amber-500 text-[10px] uppercase font-bold tracking-widest font-mono">Queue Load</p>
                        <i class="fas fa-user-clock text-amber-400 opacity-80"></i>
                    </div>
                    <h3 class="text-3xl font-bold text-white tracking-widest font-mono" id="stat-waiting">--</h3>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[calc(100vh-280px)]">
                ...
                <!-- Live Activity Feed -->
                <div class="lg:col-span-2 glass-panel p-6 flex flex-col h-full relative">
                    <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-cyan-500/50 to-transparent"></div>
                    <h3 class="text-lg font-bold text-white mb-6 uppercase font-mono tracking-widest flex items-center">
                        <i class="fas fa-stream mr-3 text-cyan-400"></i> Transaction Stream
                    </h3>
                ...
                <!-- Leaderboard -->
                <div class="glass-panel p-6 flex flex-col h-full relative">
